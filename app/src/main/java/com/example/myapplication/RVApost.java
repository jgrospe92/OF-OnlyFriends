...
public class RVApost extends RecyclerView.Adapter<RVApost.VIewHolder>{
    ...
    public RVApost(Context context, ArrayList<Post> postsData, SharedPreferences user) {
    ...
    @Override
    public void onBindViewHolder(@NonNull RVApost.VIewHolder holder, int position) {
    ...
    private void showCommentDialog(String postID, @NonNull RVApost.VIewHolder holder, int pos){
    ...
    void setClickListener(RVApost.ItemClickListener itemClickListener) {
