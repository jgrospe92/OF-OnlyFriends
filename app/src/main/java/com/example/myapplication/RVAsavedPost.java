...
public class RVAsavedPost extends RecyclerView.Adapter<RVAsavedPost.ViewHolder>{

    private ArrayList<Post> postsData;
    private LayoutInflater mInflater;

    public RVAsavedPost(Context context, ArrayList<Post> postsData)
    {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new RVAsavedPost.ViewHolder(LayoutInflater.from(parent.getContext()).inflate(R.layout.like_post_with_image, parent, false));
    }
